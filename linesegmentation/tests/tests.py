...
class TestStringMethods(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.model_line = os.path.join(self.project_dir, 'demo/models/line/marked_lines/best_model.h5')
        self.t_callback = DummyLineDetectionCallback(total_steps=8, total_pages=1)
